...
export class Sdk extends HeyApiClient {
   ...
   * Request a stream.
   */
  public streamStream<ThrowOnError extends boolean = false>(
    options: Options<StreamStreamRequest, ThrowOnError>,
  ) {
    ...
    >({
      requestValidator: async (data) =>
        await StreamStreamRequestSchema.parseAsync(data),
      responseValidator: async (data) =>
        await StreamStreamResponseSchema.parseAsync(data),
      url: "/stream",
      ...options,
      headers: {
